...
module.exports=function e(t){Object.freeze(t);var o="function"==typeof t,n=Object.prototype.hasOwnProperty;return Object.getOwnPropertyNames(t).forEach(function(r){!n.call(t,r)||(o?"caller"===r||"callee"===r||"arguments"===r:0)||null===t[r]||"object"!=typeof t[r]&&"function"!=typeof t[r]||Object.isFrozen(t[r])||e(t[r])}),t};
...
(function (global){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{"default":t}}function _taggedTemplateLiteralLoose(t,e){return t.raw=e,t}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}exports.__esModule=!0;var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var i=arguments[e];for(var s in i)Object.prototype.hasOwnProperty.call(i,s)&&(t[s]=i[s])}return t},_templateObject=_taggedTemplateLiteralLoose(['<img alt="','" src="','">'],['<img alt="','" src="','">']),_Utils=require("../core/Utils"),_Utils2=_interopRequireDefault(_Utils),_Translator=require("../core/Translator"),_Translator2=_interopRequireDefault(_Translator),_prettyBytes=require("pretty-bytes"),_prettyBytes2=_interopRequireDefault(_prettyBytes),_yoYo=require("yo-yo"),_yoYo2=_interopRequireDefault(_yoYo),_events=require("events"),_events2=_interopRequireDefault(_events),_deepFreezeStrict=require("deep-freeze-strict"),_deepFreezeStrict2=_interopRequireDefault(_deepFreezeStrict),_UppySocket=require("./UppySocket"),_UppySocket2=_interopRequireDefault(_UppySocket),Core=function(){function t(e){_classCallCheck(this,t);var i={locales:require("../locales/en_US.js"),autoProceed:!0,debug:!1};this.opts=_extends({},i,e),this.types=["presetter","orchestrator","progressindicator","acquirer","modifier","uploader","presenter","debugger"],this.type="core",this.plugins={},this.translator=new _Translator2["default"]({locales:this.opts.locales}),this.i18n=this.translator.translate.bind(this.translator),this.getState=this.getState.bind(this),this.updateMeta=this.updateMeta.bind(this),this.initSocket=this.initSocket.bind(this),this.emitter=new _events2["default"].EventEmitter,this.state={files:{}},this.opts.debug&&(global.UppyState=this.state,global.uppyLog="",global.UppyAddFile=this.addFile.bind(this))}return t.prototype.updateAll=function(t){var e=this;Object.keys(this.plugins).forEach(function(i){e.plugins[i].forEach(function(e){e.update(t)})})},t.prototype.setState=function(t){var e=_extends({},this.state,t);this.emitter.emit("state-update",this.state,e,t),this.state=e,this.updateAll(this.state),this.log("Updating state with: "),this.log(e)},t.prototype.getState=function(){return(0,_deepFreezeStrict2["default"])(this.state)},t.prototype.updateMeta=function(t,e){var i=_extends({},this.getState().files),s=_extends({},i[e].meta,t);i[e]=_extends({},i[e],{meta:s}),this.setState({files:i})},t.prototype.addFile=function(t){var e=this,i=_extends({},this.state.files),s=_Utils2["default"].getFileType(t)?_Utils2["default"].getFileType(t).split("/"):["",""],r=s[0],o=s[1],n=_Utils2["default"].getFileNameAndExtension(t.name)[1],a=t.isRemote||!1,l=_Utils2["default"].generateFileID(t.name);i[l]={source:t.source||"",id:l,name:t.name||"noname",extension:n||"",meta:{name:t.name||"noname"},type:{general:r,specific:o},data:t.data,progress:0,totalSize:t.data.size?(0,_prettyBytes2["default"])(t.data.size):"?",uploadedSize:0,isRemote:a,remote:t.remote||""},this.setState({files:i}),"image"!==r||a||_Utils2["default"].readImage(i[l].data,function(i,s){if(i)return e.log(i);var r=200,o=_Utils2["default"].getProportionalImageHeight(s,r),n=_Utils2["default"].resizeImage(s,r,o),a=_extends({},e.getState().files),u=_extends({},a[l],{previewEl:(0,_yoYo2["default"])(_templateObject,t.name,n),preview:n});a[l]=u,e.setState({files:a})}),this.emitter.emit("file-added",l),this.opts.autoProceed&&this.emitter.emit("next")},t.prototype.actions=function(){var t=this;this.emitter.on("file-add",function(e){t.addFile(e)}),this.emitter.on("file-remove",function(e){var i=_extends({},t.state.files);delete i[e],t.setState({files:i})}),this.emitter.on("upload-progress",function(e){var i=(e.bytesUploaded/e.bytesTotal*100).toFixed(2);i=Math.round(i);var s=_extends({},t.getState().files),r=_extends({},s[e.id],{progress:i,uploadedSize:e.bytesUploaded?(0,_prettyBytes2["default"])(e.bytesUploaded):"?"});s[e.id]=r;var o=Object.keys(s).map(function(t){return 0!==t.progress}),n=100*Object.keys(o).length,a=0;Object.keys(s).forEach(function(t){a+=s[t].progress});var l=100*a/n;t.setState({totalProgress:l,files:s})}),this.emitter.on("upload-success",function(e,i){var s=_extends({},t.getState().files),r=_extends({},s[e],{uploadURL:i});s[e]=r,t.setState({files:s})})},t.prototype.use=function(t,e){var i=new t(this,e),s=i.id;if(this.plugins[i.type]=this.plugins[i.type]||[],!s)throw new Error("Your plugin must have a name");if(!i.type)throw new Error("Your plugin must have a type");var r=this.getPlugin(s);if(r){var o="Already found a plugin named '"+r.name+"'.\n        Tried to use: '"+s+"'.\n        Uppy is currently limited to running one of every plugin.\n        Share your use case with us over at\n        https://github.com/transloadit/uppy/issues/\n        if you want us to reconsider.";throw new Error(o)}return this.plugins[i.type].push(i),this},t.prototype.getPlugin=function(t){var e=!1;return this.iteratePlugins(function(i){var s=i.id;return s===t?(e=i,!1):void 0}),e},t.prototype.iteratePlugins=function(t){var e=this;Object.keys(this.plugins).forEach(function(i){e.plugins[i].forEach(t)})},t.prototype.log=function(t){this.opts.debug&&(t===""+t?console.log("LOG: "+t):console.dir(t),global.uppyLog=global.uppyLog+"\nDEBUG LOG: "+t)},t.prototype.runType=function(t,e,i){var s=this.plugins[t].map(function(t){return t[e](_Utils2["default"].flatten(i))});return Promise.all(s)["catch"](function(t){return console.error(t)})},t.prototype.run=function(){var t=this;this.log("Core is run, initializing actions, installing plugins..."),this.actions(),this.plugins.acquirer&&this.plugins.acquirer.length>1&&(this.opts.autoProceed=!1),Object.keys(this.plugins).forEach(function(e){t.plugins[e].forEach(function(t){t.install()})})},t.prototype.initSocket=function(t){return this.socket||(this.socket=new _UppySocket2["default"](t)),this.socket},t}();exports["default"]=Core;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function promiseWaterfall(e){var t=e[0],n=e.slice(1),r=n.reduce(function(e,t){return e.then(t)},t([]));return r}function flatten(e){return[].concat.apply([],e)}function isTouchDevice(){return"ontouchstart"in window||navigator.maxTouchPoints}function $$(e,t){var n;return"string"!=typeof e?(n=e,Array.prototype.slice.call(n)):void(n=(t||document).querySelectorAll(e))}function $(e,t){return(t||document).querySelector(e)}function truncateString(e,t){return e.length>t?e.substring(0,t)+"…":e}function groupBy(e,t){return e.reduce(function(e,n){var r=t(n),a=e.get(r)||[];return a.push(n),e.set(r,a),e},new Map)}function every(e,t){return e.reduce(function(e,n){return e?t(n):!1},!0)}function toArray(e){return Array.prototype.slice.call(e||[],0)}function generateFileID(e){var t=e.toLowerCase();return t=t.replace(/[^A-Z0-9]/gi,""),t+=Date.now()}function extend(){for(var e=arguments.length,t=Array(e),n=0;e>n;n++)t[n]=arguments[n];return Object.assign.apply(this,[{}].concat(t))}function getFnName(e){var t="function"==typeof e,n=t&&(e.name&&["",e.name]||e.toString().match(/function ([^\(]+)/));return!t&&"not a function"||n&&n[1]||"anonymous"}function readImage(e,t){var n=new FileReader;n.addEventListener("load",function(e){var n=e.target.result,r=new Image;r.addEventListener("load",function(){return t(null,r)}),r.addEventListener("error",function(e){return t(e)}),r.src=n}),n.addEventListener("error",function(e){console.log("FileReader error "+e)}),n.readAsDataURL(e)}function getProportionalImageHeight(e,t){var n=e.width/e.height,r=Math.round(t/n);return r}function getFileType(e){return e.type?e.type:_mimeTypes2["default"].lookup(e.name)}function getFileNameAndExtension(e){var t=/(?:\.([^.]+))?$/,n=t.exec(e)[1],r=e.replace("."+n,"");return[r,n]}function resizeImage(e,t,n){var r=document.createElement("canvas"),a=r.getContext("2d");return r.width=t,r.height=n,a.drawImage(e,0,0,t,n),r.toDataURL("image/png")}exports.__esModule=!0,exports.$$=$$,exports.$=$;var _mimeTypes=require("mime-types"),_mimeTypes2=_interopRequireDefault(_mimeTypes);exports["default"]={promiseWaterfall:promiseWaterfall,generateFileID:generateFileID,getFnName:getFnName,toArray:toArray,every:every,flatten:flatten,groupBy:groupBy,$:$,$$:$$,extend:extend,readImage:readImage,resizeImage:resizeImage,getProportionalImageHeight:getProportionalImageHeight,isTouchDevice:isTouchDevice,getFileNameAndExtension:getFileNameAndExtension,truncateString:truncateString,getFileType:getFileType};
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}exports.__esModule=!0;var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e},_Plugin2=require("./Plugin"),_Plugin3=_interopRequireDefault(_Plugin2),_tusJsClient=require("tus-js-client"),_tusJsClient2=_interopRequireDefault(_tusJsClient),_UppySocket=require("../core/UppySocket"),_UppySocket2=_interopRequireDefault(_UppySocket),_Promise="undefined"==typeof Promise?require("es6-promise").Promise:Promise,Tus10=function(e){function t(o,r){_classCallCheck(this,t);var n=_possibleConstructorReturn(this,e.call(this,o,r));n.type="uploader",n.id="Tus",n.title="Tus";var s={};return n.opts=_extends({},s,r),n}return _inherits(t,e),t.prototype.upload=function(e,t,o){var r=this;return this.core.log("uploading "+t+" of "+o),new _Promise(function(t,o){var n=new _tusJsClient2["default"].Upload(e.data,{metadata:e.meta,resume:!1,endpoint:r.opts.endpoint,onError:function(e){o("Failed because: "+e)},onProgress:function(t,o){r.core.emitter.emit("upload-progress",{uploader:r,id:e.id,bytesUploaded:t,bytesTotal:o})},onSuccess:function(){r.core.emitter.emit("upload-success",e.id,n.url),r.core.log("Download "+n.file.name+" from "+n.url),t(n)}});r.core.emitter.on("file-remove",function(t){t===e.id&&n.abort()}),n.start()})},t.prototype.uploadRemote=function(e,t,o){var r=this;return new _Promise(function(t,o){console.log(e.remote.url),fetch(e.remote.url,{method:"post",credentials:"include",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify(_extends({},e.remote.body,{target:r.opts.endpoint,protocol:"tus"}))}).then(function(n){return n.status<200&&n.status>300?o(n.statusText):void n.json().then(function(o){var n=/^(?:https?:\/\/)?(?:[^@\/\n]+@)?(?:www\.)?([^:\/\n]+)/,s=n.exec(e.remote.host)[1],i=o.token,u=new _UppySocket2["default"]({target:"ws://"+s+":3121/api/"+i});u.on("progress",function(o){return o.complete?(r.core.log("Remote upload of '"+e.name+"' successful"),r.core.emitter.emit("upload-success",e),t("Success")):void(o.progress&&(r.core.log("Upload progress: "+o.progress),r.core.emitter.emit("upload-progress",{uploader:r,id:e.id,bytesUploaded:o.bytesUploaded,bytesTotal:o.bytesTotal})))})})})})},t.prototype.uploadFiles=function(e){var t=this,o=[];return e.forEach(function(r,n){var s=parseInt(n,10)+1,i=e.length;r.isRemote?o.push(t.uploadRemote(r,s,i)):o.push(t.upload(r,s,i))}),Promise.all(o).then(function(){return{uploadedCount:e.length}})},t.prototype.selectForUpload=function(e){var t=Object.keys(e).filter(function(t){return!(0!==e[t].progress&&!e[t].isRemote)}).map(function(t){return e[t]});this.uploadFiles(t)},t.prototype.install=function(){var e=this;this.core.emitter.on("next",function(){e.core.log("Tus is uploading...");var t=e.core.state.files;e.selectForUpload(t)})},t}(_Plugin3["default"]);exports["default"]=Tus10;
